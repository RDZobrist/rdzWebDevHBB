...
<div id="page-wrapper"><div id="page">
  <div class="header-top container">
  	<div class="row">
	    ...
	    <div class="header-top-middle col-sm-7">
	    <div class="header-middle-top">
	      <?php print render($page['header_middle_top']); ?>
	    </div>
	    ...
	    <div class="header-top-right col-sm-3">
	      <div class="header-top-right-top">
	       <?php print render($page['header_top_right_top']); ?>
	      </div>
	      
	      <div class="header-top-right-bottom">
	       <?php print render($page['header_top_right_bottom']); ?>
	      </div>
	    </div>
	  </div>
  </div>
	      ...
	      <div class="row">
	        ...
	        <div class="footer-right col-md-8">
	          <div class="footer-right-top">
	            <?php print render($page['footer_right_top']); ?>
	          </div>
	          <div class="clearfix"></div>
	          <div class="footer-right-bottom">
	            <?php print render($page['footer_right_bottom']); ?>
	          </div>
	        </div>
	      </div>
      </div>
  ...
  <div class="page-bottom">
  	<div class="container">
    <?php print render($page['page_bottom_region']); ?>
    </div>
  </div>
