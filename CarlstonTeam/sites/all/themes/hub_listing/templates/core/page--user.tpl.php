          ...
          <?php endif; ?>
            ...
            <?php
                  ...
                  if(arg(0) == 'user' && arg(1) == $user->uid && arg(2) == '')
                       {
		   $username=user_load($user->uid);
                   echo '<h2>'.$username->name.'</h2>';
                   //dsm($username);
                   //echo "hello";
                 }
              ?>
      ...
      <div class="container">
        <div id="content">
          ...
          <div class="user_profile">
           ...
           global $user;
            $user->uid ;
            if(arg(0) == 'user' || arg(0) == 'users' && arg(1) == $user->uid && arg(2) == '')
                 {
                 
          $view = views_get_view('user_profile');
