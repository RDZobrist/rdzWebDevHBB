 ...
 */
		...
		$parent_name = $term_parent[1]->name;
?>
...
<span class="hublisting">HUB LISTING SERVICE</span>
<span class="salt">
...
// dsm($current_node);
$state = taxonomy_term_load($current_node->field_state1['und'][0]['tid'])->name;
$city = taxonomy_term_load($current_node->field_state1['und'][1]['tid'])->name;
...
<div class ='container'>
<?php
    print views_embed_view('footer_view_block', 'block_1', $node->nid); 
?>
</div>
</div>
