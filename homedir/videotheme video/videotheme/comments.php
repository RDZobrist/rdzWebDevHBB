...
<?php if ( get_comment_type() == "comment" ) : ?>
                        ...
                        <div class="comment_body">
							<?php sandbox_commenter_avatar()  ?>
							<?php comment_text() ?>
                            
							<div class="comment-meta">By <?php sandbox_commenter_link(); printf(__(' on %1$s', 'sandbox'),
										get_comment_date(),
										get_comment_time(),
										'#comment-' . get_comment_ID() );
										edit_comment_link(__('Edit', 'sandbox'), ' <span class="edit-link">(', ')</span>'); ?>
                                        </div>
